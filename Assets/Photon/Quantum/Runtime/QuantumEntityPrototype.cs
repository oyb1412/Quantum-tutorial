...
#pragma warning restore CS0618
  ...
  public abstract class EntityPrototype
    ...
    public struct PhysicsBodyGeneric {
      ...
      /// 
      /// </summary>
      public Prototypes.PhysicsBodyInertiaMode InertiaMode;
      /// <summary>
      /// The body mass.
      /// </summary>
      public FP Mass;
      ...
      /// 
      /// </summary>
      [DrawIf(nameof(InertiaMode), (int)Prototypes.PhysicsBodyInertiaMode.Explicit, Hide = true)]
      ...
      /// 
      /// </summary>
      [DrawIf(nameof(InertiaMode), (int)Prototypes.PhysicsBodyInertiaMode.ParametricShape, Hide = true)]
    ...
    public PhysicsBodyGeneric PhysicsBody = new PhysicsBodyGeneric() {
      ...
      InertiaMode = Prototypes.PhysicsBodyInertiaMode.ColliderShape,
